    ...
    return (
        <div className="main-privacy-content px-32 py-16">
            <div className="content-container">
                ...
                <div className="main-content">
                    ...
                    <p className="note">
                        <b>
                            {" "}
                            Note: Your trust while using our platform is most important to us.
                            We do our best to ensure your experience and data is safe with us.
                        </b>
                    </p>
                    <br></br>
                    <p className="contentpartstart">
                        By accessing this website we assume you accept these terms and
                        conditions in full. Do not continue to use AI Minds’s website/apps
                        if you do not accept all of the terms and conditions stated on this
                        page.
                    </p>
                    <br></br>
                    <p className="contentparttwo">
                    ...
                    <br></br>
                    <p className="contentpartthree">
                        The “Terms and Conditions” agreement.This is optional but
                        recommended. Use this agreement to set the rules and guidelines for
                        users when they register an account with you. You could add the
                        Return and Refund Policy in your Terms and Conditions rather than
                        having a separate agreement on returns.
                    </p>

                    <br></br>
                    <h3>Payments & cancellations</h3>
                    <h3> A. Billing</h3>
                    <p className="billingcontent">
                        You may purchase a Paid Subscription directly from our website or
                        app or through a third party either by (1) paying a subscription fee
                        in advance on a monthly basis or some other recurring interval
                        disclosed to you prior to your purchase; or (2) pre-payment giving
                        you access to the website/app content/service for a specific time
                        period (“Pre-Paid Period”).
                    </p>
                    <br></br>
                    <p className="billingcontent">
                        We may change the price for the Paid Subscriptions, including
                        recurring subscription fees, the Pre-Paid Period (for periods not
                        yet paid), or Codes, from time to time and will communicate any
                        ...
                        Subject to applicable law, you accept the new price by continuing to
                        access our website/app service after the price change takes effect.
                        If you do not agree with a price change, you have the right to
                        reject the change by unsubscribing from the Paid Subscription prior
                        to the price change going into effect.
                    </p>

                    <h3>B. Renewal; Cancellation</h3>
                    <p className="renewalcontent">
                        Unless your Paid Subscription has been purchased for a Pre-Paid
                        Period, your payment to our website/apps or the third party through
                        which you purchased the Paid Subscription will automatically renew
                        at the end of the applicable subscription period, unless you cancel
                        your Paid Subscription before the end of the then-current
                        subscription period. If you purchased the Paid Subscription through
                        our website/app, or if you purchased the Paid Subscription through a
                        third party, by canceling the Paid Subscription through such third
                        party. The cancellation will take effect the day after the last day
                        of the current subscription period and you will be downgraded to the
                        Free Service. If you purchased your Paid Subscription through our
                        website/app and you cancel your payment or Paid Subscription and/or
                        terminate any of the Agreements before the end of the current
                        subscription period, we will not refund any subscription fees
                        already paid to us. If you wish to receive a full refund of all
                        monies paid to our website/app for genuine reasons, you must contact
                        Customer Support at hello@programminghub.io. The decision to grant a
                        refund solely depends on us. When we process any refund, we will
                        refund amounts using the method you used for payment.
                        <br></br>
                        <br></br>If you have purchased a Paid Subscription using a Code,
                        your subscription will automatically terminate at the end of the
                        period stated in the Code. If you have purchased your Paid
                        Subscription through a third party, you must cancel directly with
                        that third party.
                    </p>
                    <h3>Cookies</h3>
                    <p className="cookiescontent">
                        We employ the use of cookies. By using AI Minds’s website/apps you
                        consent to the use of cookies in accordance with AI Minds's privacy
                        policy. Most of the modern day interactive websites use cookies to
                    ...
                    <h3>License</h3>
                    <p className="license">
                        Unless otherwise stated, AI Minds and/or it's licensors own the
                        intellectual property rights for all material on AI Minds are
                        reserved. You may view and/or print pages from our websites/apps for
                        your own personal use subject to restrictions set in these terms and
                        conditions. Redistribute content from AI Minds (unless content is
            ...
            `}</style>
                        <ol>
                            <li>
                                Certain parts of this website/blog/apps/forum offer the
                                opportunity for users to post and exchange opinions,
                                information, material, and data ('Comments') in areas of the
                                website/blog/apps/forum. AI Minds does not screen, edit,
                                publish, or review Comments prior to their appearance on the
                                website and Comments do not reflect the views or opinions of AI
                                Minds, its agents or affiliates. Comments reflect the view and
                                opinion of the person who posts such view or opinion. To the
                                extent permitted by applicable laws AI Minds shall not be
                            ...
                            <li>
                                AI Minds reserves the right to monitor all Comments and to
                            ...
                            <li>
                                You hereby grant to AI Minds a non-exclusive royalty-free
            ...
            `}</style>
                        <ol>
                            ...
                            <li>
                                These organizations may link to our home page, and/or our
                    ...
                    <div className="commonpara">
                        <p className="content">
                            ...
                            associated with the hyperlink outweighs the absence of AI Minds;
                            and (d) where the link is in the context of general resource
                        ...
                        <p className="content">
                            ...
                            notify us by sending an email to hello@programminghub.io. Please
                            ...
                            our Web site, and a list of the URL(s) on our site to which you
                            would like to link. Allow 2-3 weeks for a response. Approved
                            organizations may hyperlink to our Web site as follows:
                        </p>
                    </div>
              ...
              /* Add a specific style for unordered list items */
              .bulletcontent ul li::before {
                content: "•"; /* Unicode character for a bullet point */
                font-weight: bold;
                position: absolute;
                left: -20px;
            ...
            `}</style>
                        ...
                        <ul>
                            <li>
                                ...
                                description of our Web site or material being linked to that
                                makes sense within the context and format of content on the
                                linking party's site. No use of AI Minds’s logo or other artwork
                            ...
                            <li>
                                ...
                                of content on the linking party's site. No use of AI Minds’s
            ...
            `}</style>
                        ...
                        <ol>
                            <li>
                                ...
                                injury resolting from negligence;
                            </li>
                            <li>
